...
This paper studies the dynamics of asset prices and unemployment when expectations deviate from a rational benchmark. Using machine learning forecasts as an objective benchmark for rational and efficient beliefs, I quantify distortions in survey forecasts of firms' future cash flows and discount rates. Survey forecasts overreact to cash flow news, while machine forecasts do not. These distortions explain a large share of variation in aggregate and firm-level hiring. Following positive idiosyncratic shocks, firms with distorted beliefs overhire relative to firms whose beliefs are less distorted. Results suggest that distorted beliefs about firms' future cash flows can explain both volatility in aggregate unemployment and dispersion in firm-level hiring. A search model in which firms learn about the long-run mean of their cash flows with fading memory can reproduce these patterns by generating a large share of observed volatility in unemployment and asset valuations. 
<br><br>
